...
/**
 * is_digit -This is a functiont that confirms if a string contains a non-digit char
...
/**
 * main - Gives the product of two positive numbers
 * @argc:This is number of arguments
 * @argv:This is array of arguments
 *
